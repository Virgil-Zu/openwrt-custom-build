...
sed -i 's|compatible = "phicomm,k2-v22.5"|compatible = "phicomm,k2-v22.5"|g' openwrt/target/linux/ramips/dts/mt7620a_phicomm_k2-v22.5-16m.dts
...
sed -i 's|TARGET_DEVICES += phicomm_k2-v22.5|\n\ndefine Device/phicomm_k2-v22.5-16m  $(Device/phicomm_k2-v22.5)\n  IMAGE_SIZE := 15744k\n  DEVICE_VARIANT := 16M\n  SUPPORTED_DEVICES += k2-v22.5-16m\nendef\nTARGET_DEVICES += phicomm_k2-v22.5-16m|g' openwrt/target/linux/ramips/image/mt7621.mk
